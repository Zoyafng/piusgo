...
const nav = [
  ['/offers/recharge','充值优惠',Gift,'promo'],['/offers/newcomer','新人优惠',Ticket,'promo'],
...
export function Brand() {
  return <Link className="brand" href="/" aria-label="AI云充首页"><img src="/assets/site-logo.png" alt="" width={40} height={40}/><span><strong>AI云充</strong><small>BUY&FAST</small></span></Link>;
}
